...
if (!$errors && !$missing) {
    ...
    $replacements = [
        'edilson.mendes@primeconsulting.org'  =>
            ['#subject#' => 'Avaliação RESIDENCIAL GOA']
   ];
    ...
    try {
        ...
        $message = Swift_Message::newInstance()
            ...
            $image_ilha = $message->embed(Swift_Image::fromPath('assets/img/saovicente.png'));
            $image_logo = $message->embed(Swift_Image::fromPath('assets/img/logo1.jpg'));
...
center">Avaliação RESIDENCIAL GOA</h1>
</td>
</tr>
<tr>
